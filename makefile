...
$(OBJ_DIR)/humanPlayer.o: $(SRC_DIR)/humanPlayer.cpp $(INCLUDE_DIR)/player.h $(INCLUDE_DIR)/humanPlayer.h
	$(CC) -c $(SRC_DIR)/humanPlayer.cpp -o $(OBJ_DIR)/humanPlayer.o
$(OBJ_DIR)/AIPlayer.o: $(SRC_DIR)/AIPlayer.cpp $(INCLUDE_DIR)/player.h $(INCLUDE_DIR)/board.h $(INCLUDE_DIR)/AIPlayer.h
...
$(OBJ_DIR)/test-game: $(OBJ_DIR)/game.o $(OBJ_DIR)/board.o $(OBJ_DIR)/error.o $(OBJ_DIR)/humanPlayer.o $(OBJ_DIR)/AIPlayer.o $(TEST_DIR)/game.cpp
	$(CC) $(TEST_DIR)/game.cpp $(OBJ_DIR)/game.o $(OBJ_DIR)/board.o $(OBJ_DIR)/error.o $(OBJ_DIR)/humanPlayer.o $(OBJ_DIR)/AIPlayer.o -o $(OBJ_DIR)/test-game
run-test-error: $(OBJ_DIR)/test-error
	$(OBJ_DIR)/test-error 
run-test-board: $(OBJ_DIR)/test-board
	$(OBJ_DIR)/test-board
run-test-game: $(OBJ_DIR)/test-game
	$(OBJ_DIR)/test-game Dhwani 